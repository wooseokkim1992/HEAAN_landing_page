...
const Input = ({
  ...
  return (
    <div className={`flex w-full flex-col justify-center gap-1`}>
      <label
        htmlFor={id}
        className={`${showLabel ? "block" : "hidden"} text-text03 text-xs`}
      >
        {labelText}
      </label>
      <div
        className={`${INPUT_COLOR_VAR[inputStatus]} flex items-center gap-2 border-b pb-1`}
      >
        <input
          id={id}
          name={id}
